...
# baseline
sbatch -p 1080ti-short --gres=gpu:2 --mem=80000 --output=logs/cifar_threshold_baseline.log --wrap="python -u main.py --threshold 0 --diff-dir /mnt/nfs/work1/hongyu/lalor/data/irt-svi/CIFAR/ --threshold-type 1 -p /mnt/nfs/work1/hongyu/lalor/data/irt-svi/CIFAR/thresholds/"
